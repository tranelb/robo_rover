...
// Constants
//const int forwardSpeedL = 235;  // Speed for left motor while moving forward
//const int forwardSpeedR = 185;  // Speed for right motor while moving forward
const unsigned long forwardDuration; // Duration to move forward 2 feet
const unsigned long turnDuration;    // Duration for a 90-degree turn
const unsigned long stopDuration;   // Duration to stop at corners
const unsigned long blinkInterval;   // LED blink interval in ms

// Variables for LED blinking
unsigned long previousMillis;
bool ledState = false;

Motor_LED robot(9,8,7,3,5,4,11,10,2,13,forwardDuration,turnDuration,stopDuration,blinkInterval,previousMillis,ledState);
